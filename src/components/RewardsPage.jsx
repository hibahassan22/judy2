...
export default function RewardsPage() {
  ...
  return (
    <div className="w-full min-h-screen p-6 font-sans " dir="rtl">
      {/* هنا تم تعديل العرض ليكون بعرض الشاشة بالكامل */}
      <div className="w-full space-y-5">
        ...
        <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 space-y-6">
          ...
          <button className="w-full bg-white bg-amber-500 border border-gray-200 text-gray-700 text-xs py-3.5 rounded-xl hover:bg-gray-50 transition-colors font-bold shadow-sm">
            حفظ الاعدادات
          </button>
        </div>
